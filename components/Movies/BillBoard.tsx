...
const BillBoard = () => {
    ...
    return <div className="relative h-[80vh]">
        <video autoPlay muted  loop poster={movie?.thumbnailUrl} src={movie?.videoUrl} className="w-full h-[80vh] object-cover brightness-[60%]"></video>
        <div className="absolute top-[30%] md:top-[40%] ml-4 md:ml-16">
            <p className="text-white text-xl md:text-5xl h-full w-[50%] lg:text-6xl font-bold drop-shadow-xl ">
                {movie?.title}
            </p>
            <p className="text-white text-[8px] md:text-lg lg:text-xl mt-3 md:mt-8 h-full w-[90%] md:w-[80%] lg-w-[50%] drop-shadow-xl ">
                {movie?.description}
            </p>
